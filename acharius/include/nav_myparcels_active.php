...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="../account/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../account/css/thumbnail-gallery.css" rel="stylesheet">
    <link rel="icon" href="https://achariuslab.com/img/logo/logo.png">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="https://www.achariuslab.com/account/vacant.php">To buy</a>
        </li>
        <li class="nav-item">
