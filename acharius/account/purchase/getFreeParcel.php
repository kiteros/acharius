...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="my-4 text-center text-lg-left">Choose your free slot</h1>
      <center><table>
        <?php
        $increment = 1;
        for($i = 0; $i < $size; $i++){
       ...
       <script>
        $(".slot").click(function(){
          ...
          if(!classes.includes('red')){
            window.location.href="../view/participative_buy_free.php?parcel=" + <?php echo $_GET['parcel'];?> + "&slot=" + id;
          }
